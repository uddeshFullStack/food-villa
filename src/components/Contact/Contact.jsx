...
const contactDetails = [
  ...
  },
  {
    ...
    title: "Office",
    value: "Kolkata, India",
    hint: "Demo address for Food Villa",
  },
];
    ...
    <section className="page-shell">
      ...
      <div className="content-card mt-6">
        ...
        >
          ...
          />
          <textarea
            className="search-input min-h-[120px] w-full sm:col-span-2"
            placeholder="How can we help?"
          />
          <button type="submit" className="search-btn sm:col-span-2 sm:w-fit">
            Send message
          </button>
        </form>
      </div>
